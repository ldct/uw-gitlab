...
void A0::guiLogic()
{
	...
	ImGui::Begin("Shape Properties", &showDebugWindow, ImVec2(100,100), opacity, windowFlags);
		...
		ImGui::SliderFloat("Angle", &m_shape_rotation, 0.0f, 2*PI);
